        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg-10 mx-auto">
              ...
              <p>
                For immediate assistance, you can also call or text me directly at <a href="tel:7022221964" className="text-decoration-underline">(702) 222-1964</a> or contact the office at <a href="tel:7025001955" className="text-decoration-underline">(702) 500-1955</a>. I'm here to help you discover the exceptional quality and lifestyle that Turnberry Place offers and find the perfect luxury residence that meets your needs and exceeds your expectations.
              </p>
            </div>
          </div>
        </div>
