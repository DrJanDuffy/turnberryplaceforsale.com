  ...
  return (
    <Layout menus={menus}>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Turnberry Place neighborhood: One block from Las Vegas Strip, near Wynn/Encore. 20+ Zagat restaurants, T-Mobile Arena, Allegiant Stadium nearby. Call/text 702-222-1988"
        />
      </Head>
