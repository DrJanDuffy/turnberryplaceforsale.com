          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <div className="content-section">
                ...
                <p>
                  <strong>Ready to learn more about Turnberry Place amenities?</strong> Contact the office at <a href="tel:7025001971" className="text-decoration-underline">(702) 500-1971</a> to schedule a tour of The Stirling Club and discuss how Turnberry Place's comprehensive amenities can enhance your luxury lifestyle. With my extensive knowledge of Turnberry Place and its amenities, I can help you appreciate the exceptional value that these facilities provide.
                </p>
              </div>
            </div>
          </div>
